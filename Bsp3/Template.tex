...
\usepackage[singlespacing]{setspace} %%Zeilenabstand, 1-zeilig
...
Your introduction goes here! Some examples of commonly used commands and features are listed below, to help you get started. If you have a question, please use the help menu (``?'') on the top bar to search for help or ask us a question. \cite[Albert Einstein, 1901, 99]{}
...
Die ist eine Section!
\subsection{Untersektion}
Dies ist eine Subsection
\subsubsection{Unteruntersektion - klingt echt merkwürdig..}
Wie gesagt, ist halt eine subsubsection :)
\newpage
Nächste Seite und noch ein wenig Text...
\newpage
Und noch einmal!
